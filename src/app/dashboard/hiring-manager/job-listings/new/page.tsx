...
export default function HMCreateNewJobPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-start">
        <Button variant="outline" size="sm" asChild>
          <Link href="/dashboard/hiring-manager/job-listings">
      ...
      <Card className="shadow-xl">
        <CardHeader>
          <CardTitle className="text-2xl flex items-center"><FileText className="mr-2 h-6 w-6 text-primary" /> Define New Job Posting</CardTitle>
          <CardDescription>As a Hiring Manager, outline the core details for the new role. AI can help generate content.</CardDescription>
        </CardHeader>
      </Card>
      ...
      <Form {...form}>
        <form className="space-y-8">
          ...
          <CardFooter className="flex flex-col md:flex-row justify-end gap-3 pt-8 border-t">
            <Button type="button" variant="outline" onClick={() => router.push("/dashboard/hiring-manager/job-listings")} disabled={isAiGenerating}>
              Cancel
            </Button>
